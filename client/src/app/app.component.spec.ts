...
describe('AppComponent', () => {
  const routes: Routes = [
    ...
    { path: 'dashboard', component: DummyComponent, data: { roles: ['ADMIN', 'VOLUNTEER'], permissions: ['view_dashboard_stats'] } },
  ...
  it('should allow protected routes when role and permissions match', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    ...
    expect(app.canAccessPath('/dashboard')).toBeTrue();
  });

  it('should hide protected routes when logged out', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;

    setAuthState({ loggedIn: false, systemRole: null });

    expect(app.canAccessPath('/dashboard')).toBeFalse();
  });
